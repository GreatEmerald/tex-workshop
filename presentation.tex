\documentclass[colorlinks]{beamer} % Use XeTeX for direct UTF-8
...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \item Follow the invitation link: {\scriptsize \href{https://www.overleaf.com/read/pnhvcjvphswk\#a17748}{https://www.overleaf.com/read/pnhvcjvphswk\#a17748}}
      \item Read-only; to make your own copy, click \textbf{``File''} at the top left, then \textbf{``Make a copy''} (you must be \textbf{logged in}!)
      \end{enumerate}
      \column{0.34\textwidth}
      \qrcode[nolinks,height=\textwidth]{https://www.overleaf.com/read/pnhvcjvphswk\#a17748}
    \end{columns}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
     ...
     \item 6964 packages at the moment of writing! (was 5199 in 2017)
      \begin{itemize}
