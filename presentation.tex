...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \item Follow the invitation link: {\small \href{https://www.overleaf.com/read/zkmfwrxbkvnt}{https://www.overleaf.com/read/zkmfwrxbkvnt} }
      ...
      \qrcode[nolinks,height=\textwidth]{https://www.overleaf.com/read/zkmfwrxbkvnt}
    \end{columns}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
     ...
     \item 5873 packages at the moment of writing! (was 5199 in 2017)
      \begin{itemize}
