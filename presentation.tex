...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \item Follow the invitation link: {\scriptsize \href{https://www.overleaf.com/read/hpdjbfsshtvz\#8884db}{https://www.overleaf.com/read/hpdjbfsshtvz\#8884db}}
      ...
      \qrcode[nolinks,height=\textwidth]{https://www.overleaf.com/read/hpdjbfsshtvz\#8884db}
    \end{columns}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
     ...
     \item 6745 packages at the moment of writing! (was 5199 in 2017)
      \begin{itemize}
