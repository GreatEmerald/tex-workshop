...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \item Follow the invitation link: {\small \href{https://www.overleaf.com/read/nyjyhmxnwbdv}{https://www.overleaf.com/read/nyjyhmxnwbdv} }
      ...
      \qrcode[nolinks,height=\textwidth]{https://www.overleaf.com/read/nyjyhmxnwbdv}
    \end{columns}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
     ...
     \item 5948 packages at the moment of writing! (was 5199 in 2017)
      \begin{itemize}
