...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \item Follow the invitation link: {\small \href{https://www.overleaf.com/read/gmcjhbfmxgff}{https://www.overleaf.com/read/gmcjhbfmxgff} }
      ...
      \qrcode[nolinks,height=\textwidth]{https://www.overleaf.com/read/gmcjhbfmxgff}
    \end{columns}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
     ...
     \item 6404 packages at the moment of writing! (was 5199 in 2017)
      \begin{itemize}
