...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \item Follow the invitation link: {\scriptsize \href{https://www.overleaf.com/read/cbzfrjcpwvxc\#1e4df4}{https://www.overleaf.com/read/cbzfrjcpwvxc\#1e4df4}}
      ...
      \qrcode[nolinks,height=\textwidth]{https://www.overleaf.com/read/cbzfrjcpwvxc\#1e4df4}
    \end{columns}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
     ...
     \item 6858 packages at the moment of writing! (was 5199 in 2017)
      \begin{itemize}
