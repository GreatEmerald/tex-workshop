...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \item Follow the invitation link: {\scriptsize \href{https://www.overleaf.com/read/czfbwrhcjnzm\#e5bd1d}{https://www.overleaf.com/read/czfbwrhcjnzm\#e5bd1d}}
      ...
      \qrcode[nolinks,height=\textwidth]{https://www.overleaf.com/read/czfbwrhcjnzm\#e5bd1d}
    \end{columns}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
     ...
     \item 6609 packages at the moment of writing! (was 5199 in 2017)
      \begin{itemize}
