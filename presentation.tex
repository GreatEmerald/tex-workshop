...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \item Follow the invitation link: {\small \href{https://www.overleaf.com/read/xkfqnhnmwpvp}{https://www.overleaf.com/read/xkfqnhnmwpvp}}
      ...
      \qrcode[nolinks,height=\textwidth]{https://www.overleaf.com/read/xkfqnhnmwpvp}
    \end{columns}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
     ...
     \item 6464 packages at the moment of writing! (was 5199 in 2017)
      \begin{itemize}
